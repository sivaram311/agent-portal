...
| P2 | Android mobile client | `agent-portal-extended` | **`v0.4.5`** rate-limit exempt header; `v0.4.4` SSO Custom Tabs; portal `RateLimitFilter` exempts `X-Agent-Portal-Client: android` |
