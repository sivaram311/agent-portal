...
| P2 | Android mobile client | `agent-portal-extended` | **`v0.3.0-happy-path-dev`** — supervisor happy path (Needs you → Decision sheet → stream → Archive); SSO/FCM on-device still open |
