...
| 4081 | agent-portal-public-edge | agent-portal | staging | 0.0.0.0 | retired | Was PREPROD public-IP NGINX edge; **disabled** 2026-07-16 — use hostname only |
...
| Decision | Value |
|----------|-------|
| New TCP port? | **No** — reuses agent-portal `:8080` / `:4080` / `:5080`. Public-IP edges retired. |
