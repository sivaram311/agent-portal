...
| Piece | Location |
|-------|----------|
| Release package | `H:\releases\agent-portal-0.1.5\` (PREPROD); PROD still prior until Q2 |
| Promote evidence | `H:\releases\agent-portal-0.1.5\evidence\` (Q1 closed 2026-07-12) |
